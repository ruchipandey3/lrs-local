...
{
    public class ExternalInputRowModel : NotifyPropertyChangedBase
    {
        ...
        public ExternalInputRowModel()
        {
        }

        public ExternalInputRowModel(string identitifier)
        {
        ...
        public void Init(String data)
        {
            ...
            if (data.StartsWith(identitifier))
            {
                ...
                else
                {
                    ...
                    ExternalSetting = (ExternalSettings)Convert.ToInt32(values[5]);
                    ...
                    PagerFlashMode = (PagerFlashMode)Convert.ToInt32(values[6]);
                    PagerVibeMode = (PagerVibeMode)Convert.ToInt32(values[6]);
                }
            }
        }
    }
